...
- [How to set up a TypeScript monorepo and make Go to definition work](https://medium.com/@score/how-to-set-up-a-typescript-monorepo-with-lerna-c6acda7d4559)
- [Making TypeScript monorepos play nice with other tools](https://medium.com/@score/making-typescript-monorepos-play-nice-with-other-tools-a8d197fdc680)
